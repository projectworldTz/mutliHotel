...
@section('content')
<div class="mb-4"><a href="{{ route('admin.bookings.index') }}" class="btn-ghost btn-sm">← Back to Bookings</a></div>
...
<div class="grid gap-6 lg:grid-cols-3">
    <div class="lg:col-span-2 space-y-5">
        <div class="card p-6">
            <div class="flex items-start justify-between mb-4">
                <div>
                    ...
                    <p class="text-sm text-slate-500 mt-0.5">Created {{ $booking->created_at->format('d M Y, H:i') }}</p>
                </div>
            ...
            <div class="grid gap-4 sm:grid-cols-2 text-sm">
                ...
                <div><p class="form-label mb-0.5">Hotel</p><p class="font-medium">{{ $booking->hotel->name ?? 'N/A' }}</p><p class="text-slate-500">{{ $booking->hotel->city ?? '' }}</p></div>
            ...
            <div class="mt-4 rounded-xl bg-slate-50 dark:bg-slate-700/50 p-3">
                <p class="text-xs font-semibold text-slate-500 mb-1">Special Requests</p>
        ...
        <div class="card">
            <div class="p-5 border-b border-slate-100 dark:border-slate-700"><h3 class="font-bold text-slate-900 dark:text-white">Booked Rooms</h3></div>
            <div class="table-wrap">
                <table class="table">
                    <thead><tr><th>Room</th><th>Check-in</th><th>Check-out</th><th>Nights</th><th>Price</th></tr></thead>
                    <tbody>
    ...
    <div class="space-y-4">
        <div class="card p-5 space-y-2">
            <h3 class="font-bold text-slate-900 dark:text-white mb-3">Manage Booking</h3>
