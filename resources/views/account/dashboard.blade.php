...
<div class="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
    ...
    <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        @foreach([
            ['Total Bookings',   $stats['total']       ?? 0, 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z', 'text-navy'],
            ['Upcoming',         $stats['upcoming']    ?? 0, 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', 'text-emerald-600'],
            ['Completed',        $stats['completed']   ?? 0, 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z', 'text-blue-600'],
            ['Cancelled',        $stats['cancelled']   ?? 0, 'M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z', 'text-rose-500'],
    ...
    <div class="mt-8 card">
        <div class="flex items-center justify-between p-5 border-b border-slate-100 dark:border-slate-700">
            <h2 class="font-bold text-slate-900 dark:text-white">Recent Bookings</h2>
            <a href="{{ route('account.bookings') }}" class="btn-ghost btn-sm">View All →</a>
        </div>
        @if($recentBookings->isEmpty())
            <div class="flex flex-col items-center justify-center py-12 text-center">
                <p class="text-slate-500">No bookings yet.</p>
                <a href="{{ route('hotels.index') }}" class="btn-primary mt-4">Browse Hotels</a>
            </div>
        @else
