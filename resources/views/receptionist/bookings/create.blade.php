...
@section('page-title', 'New Walk-in Booking')

@section('content')
<div class="max-w-2xl">
    <div class="mb-4"><a href="{{ route('receptionist.bookings.index') }}" class="btn-ghost btn-sm">← Bookings</a></div>
    ...
    <form method="POST" action="{{ route('receptionist.bookings.store') }}">
        ...
        <div class="space-y-5">
            ...
            <div class="card p-6 space-y-4">
                <h2 class="font-bold text-slate-900 dark:text-white">Guest Details</h2>
                <div class="grid gap-4 sm:grid-cols-2">
                    ...
                    <div>
                        <label class="form-label">Adult Guests *</label>
            ...
            {{-- Stay details --}}
            <div class="card p-6 space-y-4">
                <h2 class="font-bold text-slate-900 dark:text-white">Stay Details</h2>
                <div>
            ...
            <div class="flex gap-3">
                ...
                <a href="{{ route('receptionist.bookings.index') }}" class="btn-ghost">Cancel</a>
            </div>
        </div>
    </form>
</div>
